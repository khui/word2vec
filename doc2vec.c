...
//
//
// Try changing line 55 of your go.sh:
// time ./word2vec -train ../alldata-id.txt -output vectors.txt -cbow 0 
// -size 100 -window 10 -negative 5 -hs 1 -sample 1e-3 -threads 40 -binary 
// 0 -iter 20 -min-count 1 -sentence-vectors 1 
